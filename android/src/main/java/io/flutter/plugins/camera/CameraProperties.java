...
/**
 * An interface allowing access to the different characteristics of the device's
 * camera.
 */
public interface CameraProperties {
  ...
  /**
   * Returns the list of frame rate ranges for @see
   * android.control.aeTargetFpsRange supported by this camera device.
   *
   * <p>
   * By default maps to the @see
   * android.hardware.camera2.CameraCharacteristics#CONTROL_AE_TARGET_FPS_RANGE
   * key.
   *
   * @return android.util.Range<Integer>[] List of frame rate ranges supported by
   *         this camera device.
   */
   ...
   * android.control.aeExposureCompensation, in counts of @see
   ...
   * key.
   *
   * @return android.util.Range<Integer> Maximum and minimum exposure compensation
   ...
   * key.
   *
   * @return double Smallest step by which the exposure compensation can be
   *         changed.
   */
  double getControlAutoExposureCompensationStep();

  /**
   * Returns a list of auto-focus modes for @see android.control.afMode that are
   * supported by this camera device.
   *
   * <p>
   * By default maps to the @see
  ...
  /**
   * Returns the maximum number of metering regions that can be used by the
   ...
   *
   * @return Integer Maximum number of metering regions that can be used by the
   *         auto-exposure routine.
   */
  ...
  /**
   * Returns a list of distortion correction modes for @see
   * android.distortionCorrection.mode that are supported by this camera device.
   *
   * <p>
   * By default maps to the @see
   ...
   * key.
   *
   * @return int[] List of distortion correction modes supported by this camera
   *         device.
   */
   ...
   * <p>
   * By default maps to the @see
   * android.hardware.camera2.CameraCharacteristics.LENS_FACING key.
   *
  ...
  /**
   * Returns the shortest distance from front most surface of the lens that can be
   ...
   * key.
   *
   * @return Float Shortest distance from front most surface of the lens that can
   *         be brought into sharp focus.
   */
  Float getLensInfoMinimumFocusDistance();

  /**
   * Returns the maximum ratio between both active area width and crop region
   * width, and active area height and crop region height, for @see
   ...
   * key.
   *
   * @return Float Maximum ratio between both active area width and crop region
   *         width, and active area height and crop region height
   */
  Float getScalerAvailableMaxDigitalZoom();

  /**
   * Returns the area of the image sensor which corresponds to active pixels after
   ...
   * key.
   *
   * @return android.graphics.Rect area of the image sensor which corresponds to
   *         active pixels after any geometric distortion correction has been
   *         applied.
   */
  Rect getSensorInfoActiveArraySize();

  /**
   * Returns the dimensions of the full pixel array, possibly including black
   * calibration pixels.
   *
   * <p>
   * By default maps to the @see
   ...
   * key.
   *
   * @return android.util.Size Dimensions of the full pixel array, possibly
   *         including black calibration pixels.
   */
  Size getSensorInfoPixelArraySize();

  /**
   * Returns the area of the image sensor which corresponds to active pixels prior
   ...
   *
   * @return android.graphics.Rect Area of the image sensor which corresponds to
   *         active pixels prior to the application of any geometric distortion
   *         correction.
   */
  ...
  /**
   * Returns the clockwise angle through which the output image needs to be
   * rotated to be upright on the device screen in its native orientation.
   *
   * <p>
   * By default maps to the @see
   * android.hardware.camera2.CameraCharacteristics#SENSOR_ORIENTATION key.
   *
   * @return int Clockwise angle through which the output image needs to be
   *         rotated to be upright on the device screen in its native orientation.
   */
  int getSensorOrientation();

  /**
   * Returns a level which generally classifies the overall set of the camera
   ...
   * <ul>
   * <li>@see
   * android.hardware.camera2.CameraMetadata.INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY
   * <li>@see
   ...
   * <li>@see
   * android.hardware.camera2.CameraMetadata.INFO_SUPPORTED_HARDWARE_LEVEL_LEVEL_3
   * <li>@see
   * android.hardware.camera2.CameraMetadata.INFO_SUPPORTED_HARDWARE_LEVEL_EXTERNAL
   * </ul>
   *
   * <p>
   * By default maps to the @see
   ...
   * key.
   *
   * @return int Level which generally classifies the overall set of the camera
   *         device functionality.
   */
  int getHardwareLevel();

  /**
   * Returns a list of noise reduction modes for @see android.noiseReduction.mode
   ...
   * key.
   *
   * @return int[] List of noise reduction modes that are supported by this camera
   *         device.
   */
 ...
 * android.hardware.camera2.CameraCharacteristics class to access the different
 * characteristics.
 */
class CameraPropertiesImpl implements CameraProperties {
  ...
  public CameraPropertiesImpl(String cameraName, CameraManager cameraManager) throws CameraAccessException {
  ...
  public Rect getSensorInfoPreCorrectionActiveArraySize() {
    return cameraCharacteristics.get(CameraCharacteristics.SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE);
  }
