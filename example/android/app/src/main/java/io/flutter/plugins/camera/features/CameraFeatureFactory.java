...
/**
 * Factory for creating the supported feature implementation controlling
 * different aspects of the {@link android.hardware.camera2.CaptureRequest}.
 */
public interface CameraFeatureFactory {
         ...
         *
         * @param cameraProperties instance of the CameraProperties class containing
         *                         information about the cameras features.
         ...
         */
        AutoFocusFeature createAutoFocusFeature(@NonNull CameraProperties cameraProperties, boolean recordingVideo);
         ...
         * @param cameraName       the name of the camera which can be used to identify
         *                         the camera device.
         * @return newly created instance of the ResolutionFeature class.
         */
        default ResolutionFeature createResolutionFeature(@NonNull CameraProperties cameraProperties,
         ...
         *
         * @param cameraProperties         instance of the CameraProperties class
         *                                 containing information about the cameras
         *                                 features.
         * @param sensorOrientationFeature instance of the SensorOrientationFeature
         *                                 class containing information about the sensor
         ...
         * @param dartMessenger    instance of the DartMessenger class, used to send
         *                         state updates back to Dart.
         * @return newly created instance of the SensorOrientationFeature class.
         */
        SensorOrientationFeature createSensorOrientationFeature(@NonNull CameraProperties cameraProperties,
