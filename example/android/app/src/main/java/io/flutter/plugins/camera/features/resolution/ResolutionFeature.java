 ...
 * independent {@link ResolutionPreset} into a
 * {@link CamcorderProfile} which contains all the properties
...
public class ResolutionFeature extends CameraFeature<ResolutionPreset> {
  ...
  /**
   * Gets the {@link CamcorderProfile} containing the information to
   * configure the resolution using the {@link android.hardware.camera2} API.
   *
...
//    }
  ...
  /**
   * Gets the best possible {@link CamcorderProfile} for the
   * supplied {@link ResolutionPreset}.
   *
   * @param cameraId Camera identifier which indicates the device's camera for
   *                 which to select a {@link CamcorderProfile}.
   * @param preset   The {@link ResolutionPreset} for which is to be translated to
   *                 a {@link CamcorderProfile}.
   * @return The best possible {@link CamcorderProfile} that matches
   *         the supplied {@link ResolutionPreset}.
   */
  public static CamcorderProfile getBestAvailableCamcorderProfileForResolutionPreset(int cameraId,
